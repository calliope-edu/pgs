...
//#-code-completion(identifier, show, A3, Bb3, B3, C2, Db2, D2, Eb2, E2, F2, Gb2, G2, Ab1, A1, Bb1, B1, C1, Db, D, Eb, E, F, Gb, G, Ab, A, Bb, B, c´, db´, d´, eb´, e´, f´, gb´, g´, ab´, a´, bb´, h´, c´´, db´´, d´´, eb´´, e´´, f´´, gb´´, g´´, ab´´, a´´, bb´´, h´´, c´´´, db´´´, d´´´, eb´´´, e´´´, f´´´, gb´´´, g´´´, ab´´´, a´´´)

//#-hidden-code
playgroundPrologue()
//#-end-hidden-code

class CalliopeImplementation: Calliope {
...
//#-hidden-code
myCalliope = CalliopeImplementation()
//#-end-hidden-code
