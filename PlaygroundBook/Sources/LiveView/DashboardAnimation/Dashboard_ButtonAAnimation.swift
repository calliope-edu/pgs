...
class Dashboard_ButtonAAnimation: UIView_DashboardItemAnimation, CAAnimationDelegate {
	
    private lazy var bg_view:UIView = {
        let bg = UIView(frame: CGRect.zero)
        bg.translatesAutoresizingMaskIntoConstraints = false
        bg.backgroundColor = UIColor(named: "calliope-brightturquoise")
        return bg
    }()
    ...
    private let button_name:String = "A"
	...
	func setup() {
        ...
        NSLayoutConstraint.activate([
            ...
            charA.trailingAnchor.constraint(equalTo: container_view.trailingAnchor, constant: 0),
        ...
        NSLayoutConstraint.activate([
            ...
            charB.trailingAnchor.constraint(equalTo: container_view.trailingAnchor, constant: 0),
