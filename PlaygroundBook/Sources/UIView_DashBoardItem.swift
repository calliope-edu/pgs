...
fileprivate let dashboardItemStyles:DashboardItemStyle = [
    DashboardItemType.Display     : ["color": "8073E5"],
    DashboardItemType.RGB         : ["color": "8073E5"],
    DashboardItemType.Sound       : ["color": "8073E5"],
    DashboardItemType.ButtonA     : ["color": "42C9C9"],
    DashboardItemType.ButtonB     : ["color": "42C9C9"],
    DashboardItemType.Pin         : ["color": "42C9C9"],
    DashboardItemType.Shake       : ["color": "42C9C9"],
    DashboardItemType.Noise       : ["color": "FF4E00"],
    DashboardItemType.Thermometer : ["color": "3FC863"],
    DashboardItemType.Brightness  : ["color": "F8C633"]
]
